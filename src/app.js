...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://tablinum-sj.herokuapp.com','https://54.207.224.46/','http://54.207.224.46/'); // update to match the domain you will make the request from
